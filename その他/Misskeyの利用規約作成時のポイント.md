...
結論から話しますと、汎用サーバー以外では利用規約が必須でない場合もあります。
...
また、利用規約に従った運営がなされるため、管理者の権利濫用や曖昧な判断基準でのモデレーションを抑制することが期待できます。
...
その利用規約の内容が自身に何もわからない状態でこっそり変更されていたりすると、不利益を被る可能性が生じることを否定できません。また、利用者に不利益となる変更は、法令上の要件や相当な周知を欠く場合には有効に認められない可能性があるため、管理者にとっても望まない結果になります。
...
この分野で見識のある方がおられましたらより適切な規約のテンプレートをご提案いただけると幸いです。
